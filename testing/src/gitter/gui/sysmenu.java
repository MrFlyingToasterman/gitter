...
public class sysmenu extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "THIS IS A ALPHA\n"
                + "YOURE GOING TO DELETE ALL YOUR FILES IN THIS REPO ON GITHUB!\n"
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "THIS CAN NOT BE UNDONE!", "ALERT!", JOptionPane.ERROR_MESSAGE);
        
         String input = term + " git config --global user.name \"" + user + "\"";
         shell(input);
         input = term + " git config --global user.email \"" + user + "\"";
         shell(input);
         input = term + " git -C " + repo + " remote -v";
         System.err.println(repo);
         shell(input);
         input = term + " git -C " + repo + " add *";
         shell(input);
         
         input = JOptionPane.showInputDialog("Commit messige: ");
         String temp = term + " git -C " + repo + " commit -m \"" + input + "\"";
         shell(temp);
         
         input = term + " git -C " + repo + " push origin master";
         //input = term + "sh run.sh " + repo;
         shell(input);
         System.out.println("Ready..");
